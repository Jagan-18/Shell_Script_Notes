#which is about managing or criting users

#--------------------------------------
#write a Bash script that reads a text file containing the employees’ usernames and group names, where each line is formatted as username; groups.
...
# Author: Jagadeesh
# Date: 22-09-24
#referURL: https://gitlab.com/learndevopseasy/scripting/create_users
#---------------------------------------------#
